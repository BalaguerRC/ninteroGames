...
<template>
    <div class="card lg:card-side bg-base-100 rounded-lg shadow-xl mb-5">
        <div class="card-body">
            ...
            <div class="card-actions justify-end">
                <button v-if="notificationObj.article" class="btn btn-sm btn-primary" @click="goToItem(notificationObj.article._id, notificationObj._id, 'articles')">View article</button>
                <button v-else class="btn btn-sm btn-primary" @click="goToItem(notificationObj.game._id, notificationObj._id, 'games')">View game</button>
            </div>
        </div>
    </div>
</template>